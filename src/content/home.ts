...
export const buildHomeContent = (c: HomeContentGlobal, s: SiteSetting): HomeContent => ({
  hero: {
    ...
    mosaicDesktop: [
      { src: '/hero/booth-rollun-cropped.webp', alt: 'Rollun team at their trade-show booth' },
      { src: '/hero/rollun-shelf.webp', alt: 'Rollun-branded parts on a retail shelf' },
      { src: '/hero/chopper-rollun.webp', alt: 'Rollun team member with a custom chopper at the AIMExpo show' },
      { src: '/hero/desk-rollun.webp', alt: 'Rollun team member at her desk in a branded shirt' },
      { src: '/hero/p6.webp', alt: 'Rollun team at the Magazi booth' },
      { src: '/hero/p4.webp', alt: 'Rollun storefront — ATV/UTV and motorcycle parts' },
      { src: '/hero/p3.webp', alt: 'Rollun at the AIMExpo 2024 trade show' },
      { src: '/hero/p2.webp', alt: 'Rollun shop interior with parts and accessories' },
    ],
    // Mobile mosaic (Home Mobile.html mosaic script) — 6 tiles, empty alt.
    // Design v3 retired the stock `p1/p5/p3/p2` set in favour of the first six
    // desktop photos, so both viewports now bloom the same branded shots.
    mosaicMobile: [
      { src: '/hero/booth-rollun-cropped.webp', alt: '' },
      { src: '/hero/rollun-shelf.webp', alt: '' },
      { src: '/hero/chopper-rollun.webp', alt: '' },
      { src: '/hero/desk-rollun.webp', alt: '' },
      { src: '/hero/p6.webp', alt: '' },
      { src: '/hero/p4.webp', alt: '' },
    ],
  },
  productLines: {
    ...
    automotive: {
      ...
      slidesDesktop: [
        { src: '/cat-tires.webp', alt: 'Tires and wheels', caption: 'Tires & Wheels' },
        {
          src: '/cat-electrical.webp',
        ...
        { src: '/cat-oils.webp', alt: 'Engine oils and automotive fluids', caption: 'Oils & Fluids' },
        { src: '/cat-batteries.webp', alt: 'Batteries', caption: 'Batteries' },
      ],
      slidesMobile: [
        { src: '/cat-tires.webp', alt: 'Tires and wheels', caption: 'Tires & Wheels' },
        { src: '/cat-electrical.webp', alt: 'Electrical systems', caption: 'Electrical & Electronic' },
        { src: '/cat-oils.webp', alt: 'Oils and fluids', caption: 'Oils & Fluids' },
        { src: '/cat-batteries.webp', alt: 'Batteries', caption: 'Batteries' },
      ],
    ...
    health: {
      ...
      slidesDesktop: [
        {
          src: '/health-supplements.webp',
          alt: 'Dietary and sport supplements — protein and recovery products',
          caption: 'Dietary & Sport Supplements',
        },
        {
          src: '/health-painrelief.webp',
          alt: 'Pain relief and recovery rub applied to elbow',
          caption: 'Pain Relief & Recovery Rubs',
        },
        {
          src: '/health-orthopedic.webp',
          alt: 'Orthopedic braces and supports',
          caption: 'Orthopedic Braces & Supports',
        },
        {
          src: '/health-energy.webp',
          alt: 'Energy and focus supplement — liquid energy shot',
          caption: 'Energy & Focus Supplements',
        },
      ],
      slidesMobile: [
        { src: '/health-supplements.webp', alt: 'Supplements', caption: 'Dietary & Sport' },
        { src: '/health-painrelief.webp', alt: 'Pain relief rubs', caption: 'Pain Relief & Recovery' },
        { src: '/health-orthopedic.webp', alt: 'Orthopedic supports', caption: 'Orthopedic Supports' },
        { src: '/health-energy.webp', alt: 'Energy supplements', caption: 'Energy & Focus' },
      ],
      cta: 'EXPLORE HEALTH',
    },
  },
    ...
    cards: [
      {
        ...
        descMobile: 'Our top-rated eBay store with 2,200+ live listings of parts and accessories.',
        cta: 'VIEW STORE',
      ...
      },
      {
        ...
        descMobile: 'Fast Prime-eligible shipping and A-to-z buyer protection on our full Amazon storefront.',
        cta: 'VIEW STORE',
      ...
      },
      {
        ...
        descMobile: 'Shop our growing Walmart Marketplace catalog with easy checkout and returns.',
        cta: 'VIEW STORE',
